...
function get_lay(idx){
	...
	else if(Team_top[idx]==16){
		return 3;
	}
	else if(Team_top[idx]==8){
		return 2;
	}
	
	else if(Team_top[idx]==4){
		return 1;
	}
	return 1;
}
...
function readtable() {
	...
	document.getElementById("det_member").innerHTML=player_info["Player_Names"][0]+","+player_info["Player_Names"][1]+","+player_info["Player_Names"][2];
